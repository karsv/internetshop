...
(
    ...
    CONSTRAINT `fk_bucketId` FOREIGN KEY (`bucket_id`)
        REFERENCES `bucket` (`bucket_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `users`
VALUES (6, 'Admin',
        '10274-11086-87-29-1057738311453-124-6139738-110114-9959-15-41-
738711212410615058-85-4975564-110-1-26-75-75-20-591-1871-115-11896-48-
588861-101-88-1254033-120-385783735',
        '1aGW0LS1chCGZDzWw8qYSA==', '12dd5d85-c0b6-458e-8153-a6ee8dd2f7a9');