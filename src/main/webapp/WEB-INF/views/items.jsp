...
<table border="3">
    ...
    <c:forEach var="item" items="${items}">
        <tr>
            ...
            <td>
                <a href="${pageContext.request.contextPath}/servlet/addItemToBucket?item_id=${item.itemId}">Add</a>
            </td>
            <td>
...
<br>
<a href="${pageContext.request.contextPath}/servlet/bucket">Show bucket</a>
</br>
<br>
